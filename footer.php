    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-size-20">Mobile Store</h4>
            ...
            <div class="col-lg-4 col-12">
                ...
                <form class="form-row">
                    <div class="col d-inline-block mb-2">
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class=" font-size-14">&copy; Copyrights 2020. Desing By <a href="#" class="color-second">benaoucode</a></p>
</div>
<!-- !end #footer -->
